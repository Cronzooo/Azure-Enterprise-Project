...
A complete, production-style Azure cloud environment built CLI-first over a long weekend for portfolio and interview prep. Hub-and-spoke network topology, Azure Bastion for secure VM access, Key Vault with managed identities for secrets, Nessus vulnerability scanning, Log Analytics observability, and infrastructure-as-code via Bicep.
